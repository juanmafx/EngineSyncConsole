import { AIRCRAFT_LIMITS, ENGINE_COUNT, FUEL_CAPACITY_LB } from '../../sim/constants';
...
export function calculateTelemetryResult({
  ...
  const weightFactor = 0.94 + (1 - fuelRatio) * 0.1;
  ...
  const fullThrottleCapabilityKt = clamp(
    AIRCRAFT_LIMITS.maxSpeedKt * thrustLapse * weightFactor - climbPenalty * 500 + descentGain * 320,
    240,
